...
const DashboardGridsterConfig: GridsterConfig = {
  ...
  minCols: 2, // minimum amount of columns in the grid
  maxCols: 4, // maximum amount of columns in the grid
  minRows: 2, // minimum amount of rows in the grid
  maxRows: 3, // maximum amount of rows in the grid
